                ...
                <div class="card-head">
                    <div class="card-header">
                        <div class="heading-elements mt-0">
                            <%if (r != null && r.get(2).getCAN_ADD() == 1 || r != null && r.get(2).getCAN_EDIT() == 1) {%>
                            ...
                            <table id="mydatatable" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th>PATENTE</th> 
                                        <th>SITEWEB</th>
                                            <%if (r != null && (r.get(2).getCAN_EDIT() == 1 || r.get(2).getCAN_DELETE() == 1)) {%>
                                        <th>ACTIONS</th>
                                            <%}%>
                                    </tr>
                                </thead>
